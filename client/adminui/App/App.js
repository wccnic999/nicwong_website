...
import { Container } from 'keystone/admin/client/App/elemental';
import { Link } from 'react-router';
import { css, StyleSheet } from 'aphrodite/no-important';

import MobileNavigation from 'keystone/admin/client/App/components/Navigation/Mobile';
import PrimaryNavigation from './components/Navigation/Primary';
import SecondaryNavigation from 'keystone/admin/client/App/components/Navigation/Secondary';
import Footer from 'keystone/admin/client/App/components/Footer';
...
const App = props => {
    const listsByPath = require('keystone/admin/client/utils/lists')
        .listsByPath;
    ...
    const currentSectionKey =
        (currentSection && currentSection.key) || 'dashboard';
    return (
